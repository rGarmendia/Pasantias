...
@Entity
@IdClass(DocumentoAprobadorPK.class)
public class DocumentoAprobador
  implements Serializable, Cloneable
{
  ...
  @PrimaryKeyJoinColumn(name="documentoid", referencedColumnName="idCodigo")
...
public boolean equals(Object obj) {
	...
	if (getClass() != obj.getClass())
		return false;
	DocumentoAprobador other = (DocumentoAprobador) obj;
